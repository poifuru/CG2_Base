...
struct SpriteResource {
	...
	void Initialize(DxCommon* dxCommon) {
		...
		vertexBuffer.Initialize(dxCommon, vertices);
		...
		indexBuffer.Initialize(dxCommon, kSpriteIndexNum);
		indexBuffer.Update(indices);

		matrixBuffer.Initialize(dxCommon);
		materialBuffer.Initialize(dxCommon);
	}
